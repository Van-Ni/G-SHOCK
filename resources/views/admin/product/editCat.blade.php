        ...
        <div class="row">
            <div class="col-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.cat.update', ['id' => $product_cat->id]) }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name">Tên danh mục</label>
                                <input class="form-control" value="{{ $product_cat->cat_name }}" type="text" name="name"
                                    id="name">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <select name="cat" class="form-control" id="">
                                    ...
                                    @if (count($tree_product_cats) > 0)
                                        @foreach ($tree_product_cats as $item)
                                            @if ($product_cat->parent_id == $item['id'])
                                                @php
                                                    $selected = 'selected';
                                                @endphp
                                            @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="exampleRadios1"
                                        value="0" {{ $product_cat->status == 0 ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="exampleRadios2"
                                        value="1" {{ $product_cat->status == 1 ? 'checked' : '' }}>
